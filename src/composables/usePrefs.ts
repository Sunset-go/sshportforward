...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'logmsg.saveHost': '已保存主机「{name}」配置（mock）',
    ...
    'logmsg.pickKeyMock': '已选择私钥（mock）：{path}',
    ...
    'logmsg.disconnectingMock': '正在断开与 {host} 的连接…',
  },
  en: {
    'common.save': 'Save',
    ...
    'logmsg.saveHost': 'Saved host "{name}" config (mock)',
    ...
    'logmsg.pickKeyMock': 'Selected private key (mock): {path}',
    ...
    'logmsg.disconnectingMock': 'Disconnecting from {host}…',
  },
};
