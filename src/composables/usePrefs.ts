...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'settings.autoUpdateHint': '启动时自动检查新版本，若有更新则自动下载并安装',
    'settings.dark': '深色',
    'settings.light': '浅色',
    'settings.zh': '简体中文',
    'settings.en': 'English',
  ...
  en: {
    ...
    'settings.autoUpdateHint': 'Automatically check for new versions on startup; download and install if available',
    'settings.dark': 'Dark',
